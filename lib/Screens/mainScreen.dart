              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                        border: Border.all(color: Colors.white),
                          gradient: LinearGradient(
                              begin: Alignment.bottomRight, end: Alignment.topLeft, colors: [Color(0xFF8A2387), Color(0xFFE94057), Color(0xFFF27121)]),
                    ...
                    InkWell(
                      onTap: (){
                        scrollController.animateTo(MediaQuery.of(context).size.height*0.75, duration: Duration(milliseconds: 2000), curve: Curves.fastOutSlowIn);
                      },
                      child: Column(
                        children: [
                          Container(
